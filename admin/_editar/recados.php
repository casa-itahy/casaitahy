  ...
  <tr>
    <td colspan="2" align="right" class="titulo_noticias">
    	<div style="width:50%; height:30px; float:left">
        	Vis&iacute;vel&nbsp;
            <?php if ($status == 1){ ?>
        	<a href="php/desativar.php?id=<?php echo $id ?>&amp;v=0&amp;t=33"><img src="img/olho_visivel.gif" alt="Ativar" border="0"></a>
			<?php } else { ?>
            <a href="php/desativar.php?id=<?php echo $id ?>&amp;v=1&amp;t=33"><img src="img/olho_oculto.gif" alt="Ativar" border="0"></a>
            <?php } ?>
        </div>
