...
<table width="950" border="0" align="center" cellpadding="2" cellspacing="2">
  ...
  <tr>
    <td class="titulo_noticias">Endereco</td>
  ...
  <tr>
    ...
    <td colspan="2" class="titulo_noticias"><input name="latitude" type="text" id="latitude" size="55"  value="<?php echo $dados[0]['latitude']; ?>" /></td>
  </tr>
  <tr>
    <td class="titulo_noticias">Longitude</td>
    <td colspan="2" class="titulo_noticias"><input name="longitude" type="text" id="longitude" size="55"  value="<?php echo $dados[0]['longitude']; ?>" /></td>
  </tr>
  <tr>
        ...
        <td class="titulo_noticias">
            <select name="categoria" class="validate-selection">
                ...
                <?php foreach($categorias as $cs) { ?>
                    <option <?php if($cs['id'] == $dados[0]['categoria']) { ?>selected="selected"<?php } ?> value="<?php echo $cs['id']; ?>"><?php echo $cs['titulo']; ?></option>
                <?php } ?>
            </select>
        </td>
