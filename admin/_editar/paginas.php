...
$sql = "SELECT id,pag_tab_nome FROM modulos WHERE id=$id";
$nivel = query($sql);
...
<table width="950" border="0" align="center" cellpadding="2" cellspacing="2">
  ...
  <tr>
    <td colspan="2" height="15" align="center"><p class="msg"><?php echo $_GET['msg']; ?></p></td>
  </tr>
  <tr>
  ...
  <tr>    
    <td class="titulo_noticias" style="display:none;">
    ...
    <td class="titulo_noticias">
		...
		<?php 
	     ...
	     ?>
				...
				<div class="titulo_noticias" style="float: left; width: 140px;"><?php echo $ok; ?></div>        
...
<?php  if ($dados[0]['id'] == 6 OR $dados[0]['id'] == 3 OR $dados[0]['id'] == 2 OR $dados[0]['id'] == 4 OR $dados[0]['id'] == 5) { ?>
   <tr>
    <td class="titulo_noticias">
...
<?php
        ...
        if($ok!=false){
          if ($dados[0]['tipo'] == 11 OR $id == 7 OR $id == 7 OR $id == 9 OR $id == 15 OR $id == 16 OR $id == 17) {
  ?>
   <tr <?php if($id == 1 OR $id == 3 OR $id == 4 OR $id == 5): ?>style="display: none;"<?php endif; ?>>
    <td class="titulo_noticias">
        <div class="titulo_noticias" style="float: left; width: 140px;"><?php echo $ok; ?></div>
    <?php
  ...
  <?php     
        ...
        if($ok!=false){
  ?>
    <tr <?php if ($dados[0]['tipo'] == 5): echo "style='display: none;'"; endif ?>>
...
<tr <?php if ($id == 15 OR $id == 1 OR $id == 2 OR $id == 3 OR $id == 4 OR $id == 5 OR $id == 6): echo "style='display: none;'"; endif; ?>>
	<td colspan="2" class="titulo_noticias">
		<div style="background-color:#C5CEFA; width: 100%; text-align: center;"><?php echo $ok; ?></div>
