...
$sql = "SELECT id,nome,email, login FROM ".$paginas['pag_tab_nome']." WHERE login IS NOT NULL ORDER BY nome ASC ";
$retorno = query($sql);
  ...
  <tr>
	...
	?>
          <tr>
            ...
            <td align="center"bgcolor="<?php echo $css; ?>" class="texto_contato">
                 <a href="javascript:confirmar('php/excluir.php?id=<?php echo $x['id']?>&amp;t=<?php echo $paginas['pag_tab_id'] ?>&amp;img=0')">
