...
<table width="950" border="0" align="center" cellpadding="2" cellspacing="2">
  ...
  ?>
              <tr>
                  <td colspan="2" class="titulo_noticias">
                      <table>
                          <th colspan="<?php echo (count($idiomas)*2); ?>" style="text-align: center;" ><p style="background-color:#C5CEFA;"><?php echo $ok; ?></p></th>
                          <tr>
                              <?php $total_criado=0;
	...
	**/
    ...
    <td class="titulo_noticias">
      <div class="titulo_noticias" style='float:left; width: 120px;'><?php echo $ok; ?></div>
  ...
  <?php 
	...
	/** OCULTA IMAGEM PRINCIPAL
	*	ARI em 09/12/2011
	*	para liberar apagar essas linhas (146-147-148) e 168
