...
<script type="text/javascript">
	function geraForm(){
		...
		if (num > 0)
		{
		var url = 'php/geraFormProd.php?num='+num+'&tipo=Arquivo';
...
<form action="_gravar/docs.php" enctype="multipart/form-data" method="post" id="form" >
...
<table width="950" border="0" align="center" cellpadding="2" cellspacing="2">
  ...
  <tr>
    <td colspan="2" align="left" class="titulo_noticias">
        <p>Arquivos</p>
        <span class="valor_prod">N&deg; de Arquivos
