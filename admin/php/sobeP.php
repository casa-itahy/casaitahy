...
if($pai){
    $sql = "SELECT MIN(c.posicao) as posicao FROM paginas c
    ...
    //DESCOBRE A POSICAO DA CATEGORIA PAI ANTES DA ATUAL
        while ($flag == false){
            ...
            $sql ="SELECT csn.pag_pai_id, csn.pag_filho_id, c.posicao, c.id
                        ...
                        WHERE c.posicao = '$posicaoAnterior' AND csn.pag_filho_id IS NULL AND csn.pag_neto_id IS NULL";
        ...
        if($primeiro<$posicaoAtual){
            ...
            while ($flag == false){
                ...
                $sql ="SELECT csn.pag_pai_id, csn.pag_filho_id, c.posicao, c.id
                        ...
                        WHERE c.posicao = '$posicaoAnterior' AND csn.pag_pai_id='$pai_id' AND csn.pag_neto_id IS NULL";
            ...
            if($primeiro<$posicaoAtual){
                ...
                while ($flag == false){
                    ...
                    $sql ="SELECT csn.pag_pai_id, csn.pag_filho_id, c.posicao, c.id
                            FROM paginas c
                            INNER JOIN pag_subpag_nivel csn ON(c.id=csn.pag_filho_id)
                            WHERE c.posicao = '$posicaoAnterior' AND csn.pag_pai_id='$pai_id' AND csn.pag_filho_id='$filho_id'";
